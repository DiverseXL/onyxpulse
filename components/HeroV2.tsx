...
/* ─────────────────────────────────────────────
   ...
   Structure matches Onyx reference:
   1. Announcement bar (Live on Somnia Testnet / GitHub)
   2. Logo badge + PULSE wordmark
   3. Unified glass badge pill: [ Built on Somnia | Powered by DreamDEX ]
   4. Headline: Up or Down. That's It.
   5. Wake-line signature motif
   6. Subheadline
   7. Glass CTA button: Enter App ->
   8. Segmented glass tab-bar preview: Trade | Markets | Portfolio | Receipt
 ───────────────────────────────────────────── */
...
export default function HeroV2({ activeTab, onTabChange }: HeroV2Props) {
  ...
  useEffect(() => {
    /* Skip animation on initial mount — snap to position */
    if (initialMeasure) {
      measurePill();
  ...
  return (
    <main className={styles.hero} id="hero">
      ...
      <div className={styles.center}>
        ...
        {/* ── 2. Logo row ── */}
        <div className={styles.logoRow} aria-label="Pulse">
        ...
        {/* ── 3. Unified Glass badge pill row ── */}
        <div className={styles.badgePillContainer} aria-label="Architecture attributes">
        ...
        {/* ── 8. Segmented Glass Tab-Bar with Sliding Pill ── */}
        <div
